...
// leetcode 3341 - I & 3342. Find Minimum Time to Reach Last Room II
...
// for II we will add extra cost in alternating 1 and 2
// so first we add 1 then 2 then 1 then 2 and so on...
// so we will add a cost in struct 
